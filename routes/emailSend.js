...
router
  ...
  .get(function (req, res) {
    ...
    var cl = 'http://localhost:3001/memberform/' + req.params.memEmail;
    console.log(' req.params.memEmail:' + req.params.memEmail);
    console.log('cl:' + cl);
    var body = `<h3>您好：</h3><h3>本電子郵件為ININ SPORT服務平台所發送，若您未曾進行「ININSPORT註冊帳號」，請您忽略本電子郵件。</h3><h3>感謝你在ININSPORT上面註冊此帳號</h3><h3>認證信箱，按一下這個連結：</h3><h3><a href=${cl}>點此跳轉連結</a></h3><h3>請注意：</h3><h3>如果您無法存取這個連結，請將整個 URL 複製並貼到瀏覽器。</h3><h3>ININ團隊敬上</h3>`;
